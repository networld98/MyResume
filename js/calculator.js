...
function calculateSum() {
    ...
    const technologiesMultiSelectValue = getTechnologiesSum(technologiesMultiSelect.getValue());
    ...
    const totalSum = websiteTypeValue + technologiesMultiSelectValue + websiteCartValue + websiteReceptionValue;
